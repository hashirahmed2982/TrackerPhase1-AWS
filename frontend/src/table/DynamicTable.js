...
function DynamicTable({ TableData ,url ,catdata,waldata}) {
  ...
  const temp = ['Transid', 'createdat', 'updatedat', 'description', 'category', 'type', 'amount', 'wallet'];
  //temp.shift();
  //temp.splice(temp.indexOf('user_id'), 1);
  //temp.splice(temp.indexOf('user'), 1);
  //temp.pop();
  const column = ['INDEX', 'Transid', 'createdat', 'updatedat', 'description', 'category', 'type', 'amount', 'wallet'];
